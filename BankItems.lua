...
function BankItems_SaveZone()
	...
	if ( BankItems_Frame:IsVisible() and bankPlayer == selfPlayer ) then
		BankItems_TitleText:SetText(gsub(bankPlayerName, "|", " of ").." ("..bankPlayer.location..")")
	end
end
...
--	BagButtonAr[101]:Show()
	...
	if ( bankPlayer.location ) then
		...
		BankItems_TitleText:SetText(gsub(bankPlayerName, "|", " of "))
	end
end
...
function BankItems_UserDropdown_OnClick(button, playerName, text)
	...
	BankItems_UserDropdownText.selectedValue = playerName
...
do
	...
	BankItems_OptionsFrame:SetBackdrop(BANKITEMS_OPTIONS_BACKDROP)
	...
	CreateFrame("CheckButton", "BankItems_OptionsFrame_LockWindow", BankItems_OptionsFrame, "OptionsCheckButtonTemplate")
	...
	CreateFrame("CheckButton", "BankItems_OptionsFrame_MinimapButton", BankItems_OptionsFrame, "OptionsCheckButtonTemplate")
	...
	CreateFrame("CheckButton", "BankItems_OptionsFrame_WindowStyle", BankItems_OptionsFrame, "OptionsCheckButtonTemplate")
	...
	-- Bag Parent checkbox
	CreateFrame("CheckButton", "BankItems_OptionsFrame_BagParent", BankItems_OptionsFrame, "OptionsCheckButtonTemplate")
	...
	BankItems_BehaviorDropDown:CreateFontString("BankItems_BehaviorDropDown_Text", "BACKGROUND", "GameFontNormalSmall")
